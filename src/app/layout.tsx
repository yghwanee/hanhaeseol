...
export const metadata: Metadata = {
  ...
  // 🔴 80자 이내로 유지할 것. 네이버 간단체크가 "사용자가 쉽게 사이트를 파악할 수
  // 있도록 80자 이내로 설명문을 작성해주세요"로 경고한다(2026-08-13 실측, 종전 116자).
  // 플랫폼 이름 나열(SPOTV NOW·쿠팡플레이·티빙…)을 빼야 들어간다 — 뒷문장만 지우면
  // 90자로 여전히 초과다. 그 쿼리는 `/platform/*` 이 자기 description 으로 받는다.
  description:
    "한해설은 EPL·KBO·MLB 등 스포츠 한국어 해설 중계 편성표를 10개 플랫폼에서 모아 보여줍니다. 오늘부터 7일치.",
  keywords: [
