    ...
    <main className="relative mx-auto min-h-screen max-w-2xl px-3 pb-8 sm:px-4 sm:pb-12">
      ...
      <div className="mb-6">
        ...
        <p className="mt-1.5 text-sm leading-relaxed text-zinc-400">
          ...
          <Link href="/" className="text-zinc-300 underline underline-offset-2 hover:text-white">메인 편성표</Link>에서 볼 수 있습니다.
        </p>
      </div>
      ...
      <div id="korea">
        {data ? (
          ...
          <p className="mb-6 rounded-xl border border-zinc-800 p-4 text-sm text-zinc-400">경기 일정과 메달 데이터를 준비 중입니다.</p>
        )}
      </div>
