...
const FAQS: FaqItem[] = [
  {
    ...
    answer:
      "한국어 해설 중계는 해외 또는 국내 스포츠 경기를 한국어 캐스터·해설위원이 실시간으로 중계하는 방송을 말합니다. 같은 경기라도 플랫폼에 따라 한국어 해설을 제공하기도 하고 현지 영어·일본어·스페인어 해설만 제공하기도 합니다. 한해설은 각 경기마다 한국어 해설 제공 여부를 흰색 채움(한국어)·검은 박스(현지)·테두리만(확인 중) 뱃지로 표시합니다.",
  },
  {
