...
const SLOTS = {
  ...
  inline: {
    // PC 728x90 은 2026-08-14 재생성한 유닛이다. 옛 `DAN-lcALm7uz8M1Y77F7` 은 대시보드상
    // `승인`·유형 728x90 정상인데도 **애드핏 서버가 그 유닛에만 `NO_AD` 를 돌려줬다**(작업90).
    // 마크업·SDK·요청 파라미터 27개를 공식 형태로 맞춰도 유닛 ID 만 바꾸면 결과가 갈렸고,
    // 같은 규격으로 새로 만드니 바로 채워졌다.
    pc: { unit: "DAN-5jZ75p7iWhBxfPY5", width: 728, height: 90 },
