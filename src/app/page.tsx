...
export default function Home() {
  ...
  return (
    <div className="relative mx-auto min-h-screen max-w-2xl px-3 sm:px-4 pb-8 sm:pb-12 pt-6 sm:pt-10 xl:max-w-none xl:px-[200px]">
      {/* PC 양옆 광고 */}
      <div className="hidden xl:flex fixed left-4 top-1/2 -translate-y-1/2 z-10 flex-col gap-4">
        ...
        <a href="https://link.coupang.com/a/ekvDfQ" target="_blank" referrerPolicy="unsafe-url">
          <img src="https://ads-partners.coupang.com/banners/979118?subId=&traceId=V0-301-efafde73812c2264-I979118&w=200&h=200" alt="" />
        </a>
      </div>
      <div className="hidden xl:flex fixed right-4 top-1/2 -translate-y-1/2 z-10 flex-col gap-4">
        ...
        <a href="https://link.coupang.com/a/ekvD2e" target="_blank" referrerPolicy="unsafe-url">
          <img src="https://ads-partners.coupang.com/banners/979120?subId=&traceId=V0-301-12cd6d67384e2afb-I979120&w=200&h=200" alt="" />
        </a>
      </div>
