...
export const metadata: Metadata = {
  ...
  // 잡고 있어서 구글이 `한해설` 쿼리에 홈 대신 여기를 올렸다(2026-08-13 실측).
  // 브랜드를 꼬리로 내려 홈과의 자기경쟁을 없앤다. 소개글이라 본문에는 그대로 있다.
  title: "서비스 소개 - 스포츠 한국어 해설·한국어 중계 편성표 | 한해설",
  description:
    "10개 스포츠 중계 플랫폼의 편성표를 한 페이지에 모아, 한국어 해설 중계와 한국어 중계 편성을 한눈에 확인할 수 있는 무료 서비스입니다. 만들어진 방식과 데이터 출처를 소개합니다.",
  keywords: [
    "한해설 소개",
    "한국어 해설",
    "한국어해설",
  ...
  return (
    <main className="min-h-screen text-fg-secondary">
      <div className="max-w-[720px] mx-auto px-5 sm:px-6 pb-8 sm:pb-12 text-[14px]">
        ...
        <section className="mb-8">
          <h2 className="text-heading2 font-semibold mb-3">한국어 해설이 왜 중요할까?</h2>
          <p className="text-fg-secondary leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-heading2 font-semibold mb-3">지원 종목</h2>
          <ul className="text-fg-secondary space-y-1 list-disc list-inside">
        ...
        <section className="mb-8">
          <h2 className="text-heading2 font-semibold mb-3">지원 플랫폼</h2>
          <div className="grid grid-cols-2 gap-2 text-fg-secondary">
            <div>
              <p className="font-medium text-fg-secondary mb-1">OTT</p>
              <ul className="space-y-1 list-disc list-inside text-label1">
                <li>SPOTV NOW</li>
                <li>쿠팡플레이</li>
                <li>티빙</li>
                <li>Apple TV+</li>
            ...
            <div>
              <p className="font-medium text-fg-secondary mb-1">TV 채널</p>
              <ul className="space-y-1 list-disc list-inside text-label1">
                <li>SPOTV / SPOTV2</li>
                <li>tvN SPORTS</li>
                <li>KBS N SPORTS</li>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-2 text-label1">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-fg-secondary">해설 정보를 아직 확인하지 못한 경기</span>
            </div>
          </div>
        </section>

        <section className="mb-8">
          <h2 className="text-heading2 font-semibold mb-3">데이터 업데이트</h2>
          <p className="text-fg-secondary leading-relaxed mb-3">
          ...
          <p className="text-fg-secondary leading-relaxed">
            <Link href="/faq" className="-my-2 inline-block py-2 text-fg-brand-bright hover:underline">자주 묻는 질문</Link>에서
        ...
        <section className="mb-8">
          <h2 className="text-heading2 font-semibold mb-3">이 사이트가 만들어지는 방식</h2>
          <p className="text-fg-secondary leading-relaxed mb-3">
            편성표·순위·경기 결과는 각 플랫폼과 리그의 공개 정보를 프로그램이 자동으로
            수집·정규화한 것입니다. 사람이 일정을 손으로 입력하지 않습니다.
          </p>
          <p className="text-fg-secondary leading-relaxed mb-3">
            경기 페이지의 <strong className="text-fg-secondary">경기 미리보기</strong>는 수집된
            기록을 근거로 AI가 작성한 자동 생성 문장이며, 각 문장을 사람이 따로 검수하지는
            않습니다. 해당 섹션에 생성 시점과 함께 표시됩니다.
          </p>
          <p className="text-fg-secondary leading-relaxed">
            <Link href="/guide" className="-my-2 inline-block py-2 text-fg-brand-bright hover:underline">한해설 Topic</Link>{" "}
        ...
        <section>
          <h2 className="text-heading2 font-semibold mb-3">문의</h2>
