...
export const SPORT_SEO: SportSeoMeta[] = [
  {
    ...
    display: "야구",
    sport: "야구",
    // 🔴 2026-09-21 네이버 실측: `오늘 야구 해설` 162클릭·CTR 20.3% 로 사이트 전체 1위 쿼리였다.
    // 쿼리 문구를 제목 맨 앞에 어순 그대로 둔다(축구에서 같은 수법이 먹혔다).
    title: "오늘 야구 해설 중계 편성표 — KBO·MLB 일정 | 한해설",
    h1: "오늘 야구 해설 중계 편성표 (KBO·MLB)",
    description:
