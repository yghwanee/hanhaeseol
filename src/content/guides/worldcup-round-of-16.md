...
| 7/7(화) | 04:00 | 미정 vs 스페인 | JTBC |
| 7/7(화) | 09:00 | 미국 vs 벨기에 | JTBC |
| 7/8(수) | 01:00 | 미정 vs 미정 | JTBC |
| 7/8(수) | 05:00 | 미정 vs 미정 | JTBC |

표에서 상대가 '미정'인 경기가 3개 보이죠. 32강 경기가 7/4(토)까지 이어져서 대진이 아직 다 안 나왔거든요. 결과가 정해지는 대로 이 표도 채워서 업데이트할게요.
